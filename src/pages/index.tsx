  ...
  return (
    <>
      ...
      <section id="home" className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-4 mb-4">
        <div className="h-[34rem]  rounded-3xl p-6 lg:p-10 flex flex-col gap-16 bg-[url('/gradient-bg.jpg')] bg-cover">
        ...
        {/* foto layout */}
        <div className="w-full h-[34rem] rounded-3xl duration-300 transition ease-in-out overflow-hidden group hover:scale-[97%]">
