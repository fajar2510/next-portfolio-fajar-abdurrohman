  ...
  return (
    ...
    {/* <div className="shadow-brutalism h-full lg:h-[28rem]  rounded-3xl p-6 lg:p-10 flex flex-col gap-4 lg:gap-8 bg-[url('/gradient-bg.jpg')] bg-cover"> */}
        ...
        <p className="pb-4 pl-4 text-sm text-center md:text-start md:text-base lg:text-lg text-black"> 
          <span className='font-bold'>I’m Fajar Abdurrohman</span>, have strong passion for modern and latest technology <br/>
          For web-mobile development, design, animation and enjoy to learn new things, always open to new opportunities as well. <br/> 
        </p>
        <span className="text-base lg:text-lg text-black text-center md:text-start font-bold pl-4 pt-0">Let’s explore what I can offer! 🚀</span>
        
        <div className="flex m-4 flex-col md:flex-row items-center gap-4 lg:gap-16 mx-auto justify-between mt-auto ">             
          <Link href="mailto:abdurrohmanfajar10@gmail.com?subject=Subjek%20Email&body=Isi%20Email" target="_blank"  
