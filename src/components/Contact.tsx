        ...
        <section id="contact" className=" mb-8">
            <div className="h-full lg:h-[22rem] rounded-3xl p-8 lg:p-10 flex flex-col gap-16 bg-[url('/gradient-bg.jpg')] bg-cover">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-4 justify-between">
                    ...
                    <div>
                        <p className='text-slate-600 dark:text-white text-sm font-medium text-center lg:text-start'>Copyright © 2024 - All right reserved by Fajar Abdurrohman and Inspirate by <Link href="https://www.aboghanbari.com/" className='text-pink-600 font-medium text-sm'>aboghanbari</Link></p>
                    </div>
