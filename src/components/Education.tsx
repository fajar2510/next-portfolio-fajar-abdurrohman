        ...
        <div id="education" className=' h-full rounded-3xl px-2 lg:px-10 mt-10 flex flex-col'>
            ...
            <ol className="relative border-l border-slate-300 dark:border-slate-700">
                ...
                <li className=" ml-4">
                    ...
                    <Link href="/Sertifikat TEP Fajar Abdurrohman.pdf" download target='_blank' className="mt-4 lg:ml-3 ml-0 inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                       <span  className=' p-1 italic'> English TOEFL Prediction ( 471 )</span> <svg className="w-3 h-3 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></Link>
